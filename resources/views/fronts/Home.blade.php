				                ...
				                <ul>
				                    <li class="dropdown">
										...
										@auth
											...
											<a href="/Panier/{{ auth ()->user()->id }}" class="dropdown-toggle" data-toggle="dropdown" >
						...
						<div class="col-md-3">
							<div class="single-populer-products">
								<div class="single-populer-product-img mt40">
									<img src="{{asset('images/populer-produc')}}ts/p1.png" alt="populer-products images">
								</div>
									...
									<div class="row">
										<div class="col-md-4 col-sm-12">
											<div class="single-inner-populer-product-img">
												<img src="{{asset('images/populer-produc')}}ts/p2.png" alt="populer-products images">
											</div>
										</div>
						...
						<div class="col-md-3 col-sm-4">
							...
							<div class="single-new-arrival">
								...
								<div class="single-new-arrival-bg">
									<img src="{{asset('products/'.$p->photo)}}" alt="new-arrivals images">
									...
									<div class="new-arrival-cart">
										<p>
											...
											@auth
											<span class="lnr lnr-cart"></span>
											<a href="/Ajproduit/{{$p->id}}/{{auth()->user()->id}}">add <span>to </span> cart</a>
											@endauth
										</p>
								...
								<h4>{{$p->nom}}</h4>
								<p class="arrival-product-price">${{$p->prix}} </p>
